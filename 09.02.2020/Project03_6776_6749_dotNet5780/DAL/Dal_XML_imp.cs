...
namespace DAL
{
    public class Dal_XML_imp : Idal
    {
        ...
        public void SetLastDate()
        {
            ...
            ConfigRoot.Element("lastUpdateOrders").Value=Convert.ToString(DateTime.Today);
            ConfigRoot.Save(ConfigRootPath);
        }
        #endregion
    }
