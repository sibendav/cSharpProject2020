...
namespace DAL
{
    ...
    {        
        ...
        public List<BankBranch> AllBankBranch()//change this function
        {
                    ...
                    select new HostingUnit()
                    {
                        ...
                        Owner = new Host()
                        {
                            ...
                            BankBranchDetails=new BankBranch()
                            {
                                ...
                                BankName = (Banks)Enum.Parse(typeof(Banks),item.Element("Owner").Element("BankBranchDetails").Element("BankName").Value),
                        ...
                        diaryXML = (from it in item.Element("Diary").Elements()
